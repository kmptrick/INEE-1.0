      ...
      <div className="container" style={{ maxWidth: '780px' }}>
        ...
        {[
          ...
          },
          {
            ...
            content: `Le client s'engage à fournir à INEE S.à r.l. tous les documents, informations et accès nécessaires à la bonne exécution des prestations dans les délais convenus.\n\nToute transmission tardive ou incomplète de documents pouvant entraîner un retard dans l'exécution de la mission ne pourra être imputée à INEE S.à r.l.`,
          },
          {
            title: '7. Obligations de INEE S.à r.l.',
            content: `INEE S.à r.l. s'engage à exécuter les prestations commandées avec diligence et professionnalisme, dans le respect des règles applicables au Grand-Duché de Luxembourg.\n\nINEE S.à r.l. est soumise à une obligation de moyens et non de résultat, sauf disposition contraire expressément mentionnée dans le devis.`,
          },
          {
            title: '8. Confidentialité',
            content: `INEE S.à r.l. s'engage à maintenir strictement confidentielles toutes les informations, données et documents communiqués par le client dans le cadre de l'exécution des prestations.\n\nCette obligation de confidentialité se poursuit sans limitation de durée après la fin de la relation commerciale.`,
          },
          {
            title: '9. Propriété des travaux',
            content: `Sauf mention contraire, les livrables produits par INEE S.à r.l. dans le cadre d'une mission (rapports, analyses, supports de formation…) restent la propriété d'INEE S.à r.l. jusqu'au paiement intégral de la facture correspondante.\n\nAprès paiement complet, le client dispose d'un droit d'usage exclusif des livrables pour ses propres besoins.`,
          },
          {
          ...
          },
          {
            ...
            content: `La responsabilité de INEE S.à r.l. est limitée au montant des honoraires perçus au titre de la mission concernée.\n\nINEE S.à r.l. ne pourra être tenue responsable des préjudices indirects, notamment perte de chiffre d'affaires, perte de clientèle ou atteinte à l'image.`,
          },
          {
