      ...
      <div className="container" style={{ maxWidth: '780px' }}>
        ...
        {[
          ...
          },
          {
            ...
            content: `L'ensemble du contenu de ce site (textes, images, graphismes, logo, icônes, sons, logiciels…) est la propriété exclusive de INEE S.à r.l.-S. ou de ses partenaires.\n\nToute reproduction, distribution, modification, adaptation, retransmission ou publication de ces différents éléments est strictement interdite sans l'accord exprès par écrit de INEE S.à r.l.-S.\n\nLe logo et la marque INEE sont des marques déposées. Toute utilisation sans autorisation est passible de poursuites.`,
          },
          {
            title: '5. Liens hypertextes',
            content: `Le site inee.lu peut contenir des liens vers des sites tiers. INEE S.à r.l.-S. n'exerce aucun contrôle sur ces sites et décline toute responsabilité quant à leur contenu ou leurs pratiques en matière de protection des données.`,
          },
          {
            title: '6. Limitation de responsabilité',
            content: `INEE S.à r.l.-S. s'efforce d'assurer l'exactitude et la mise à jour des informations diffusées sur ce site. Toutefois, INEE S.à r.l.-S. ne peut garantir l'exactitude, la précision ou l'exhaustivité des informations mises à disposition.\n\nINEE S.à r.l.-S. décline toute responsabilité pour toute imprécision, inexactitude ou omission portant sur des informations disponibles sur le site, ainsi que pour tout dommage résultant d'une intrusion frauduleuse d'un tiers.`,
          },
          {
